...
\lstset{language=html,caption={Ejemplo Basico: Hola Mundo},label=DescriptiveLabel}
...
\bibitem{HTML} \textsc{Elisabeth Robson} and \textsc{Eric Freeman}. (2012) Head First HTML with Css \& XHTML.
2nd Edition (Updated for HTML5). Editor O\'Reilly Vlg. Gmbh \& Co.

\bibitem{XHTML} \textsc{Javier Eguíluz Pérez}. (2008) Introducción a XHTML. (Version Digital).
\end{thebibliography}
